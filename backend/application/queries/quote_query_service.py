"""Read-only QueryService for the quotes UI/API read models."""
...
class QuoteQueryService(BaseQueryService):
    scope = "quotes"

    def search_quotes(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
