"""Read-only QueryService for the drivers UI/API read models."""
...
class DriverQueryService(BaseQueryService):
    scope = "drivers"

    def search_drivers(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
