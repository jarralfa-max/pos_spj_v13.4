...
incident, output and yield events (PROC-2/PROC-8), packaging/label events
(PROC-13), the outbound loss-case request (PROC-15), quality request/decision
events (PROC-16), rework events (PROC-17), and the outbound alert/notification
request (PROC-20).
"""
...
class MeatProcessingEvents:
    ...
    PROCESSING_MATERIAL_RESERVED = "PROCESSING_MATERIAL_RESERVED"
    PROCESSING_MATERIAL_CONSUMED = "PROCESSING_MATERIAL_CONSUMED"

    PROCESSING_WEIGHT_CAPTURED = "PROCESSING_WEIGHT_CAPTURED"

    PROCESSING_INCIDENT_REPORTED = "PROCESSING_INCIDENT_REPORTED"
    ...
    PROCESSING_YIELD_APPROVED = "PROCESSING_YIELD_APPROVED"

    PROCESSING_PACKAGING_EXECUTED = "PROCESSING_PACKAGING_EXECUTED"
    PROCESSING_LABEL_PRINTED = "PROCESSING_LABEL_PRINTED"

    PROCESSING_LOSS_CASE_REQUESTED = "PROCESSING_LOSS_CASE_REQUESTED"

    PROCESSING_QUALITY_REQUESTED = "PROCESSING_QUALITY_REQUESTED"
    PROCESSING_OUTPUT_RELEASED = "PROCESSING_OUTPUT_RELEASED"
    PROCESSING_OUTPUT_BLOCKED = "PROCESSING_OUTPUT_BLOCKED"

    PROCESSING_REWORK_CREATED = "PROCESSING_REWORK_CREATED"
    PROCESSING_REWORK_COMPLETED = "PROCESSING_REWORK_COMPLETED"

    PROCESSING_ALERT_REQUESTED = "PROCESSING_ALERT_REQUESTED"
