...
class CRMEvents:
    ...
    TERRITORY_CREATED = "CRM_TERRITORY_CREATED"
    TERRITORY_DEACTIVATED = "CRM_TERRITORY_DEACTIVATED"
    CUSTOMER_TERRITORY_ASSIGNED = "CRM_CUSTOMER_TERRITORY_ASSIGNED"

    PORTFOLIO_CREATED = "CRM_PORTFOLIO_CREATED"
    PORTFOLIO_DEACTIVATED = "CRM_PORTFOLIO_DEACTIVATED"
    PORTFOLIO_ASSIGNED = "CRM_PORTFOLIO_ASSIGNED"
    PORTFOLIO_REASSIGNED = "CRM_PORTFOLIO_REASSIGNED"

    CUSTOMER_OWNER_ASSIGNED = "CRM_CUSTOMER_OWNER_ASSIGNED"
    CUSTOMER_OWNER_REASSIGNED = "CRM_CUSTOMER_OWNER_REASSIGNED"

    SEGMENT_CREATED = "CRM_SEGMENT_CREATED"
    SEGMENT_DEACTIVATED = "CRM_SEGMENT_DEACTIVATED"
    SEGMENT_MEMBER_ADDED = "CRM_SEGMENT_MEMBER_ADDED"
    SEGMENT_MEMBER_REMOVED = "CRM_SEGMENT_MEMBER_REMOVED"

    TAG_CREATED = "CRM_TAG_CREATED"
    TAG_DEACTIVATED = "CRM_TAG_DEACTIVATED"
    TAG_ASSIGNED = "CRM_TAG_ASSIGNED"
    TAG_REMOVED = "CRM_TAG_REMOVED"
