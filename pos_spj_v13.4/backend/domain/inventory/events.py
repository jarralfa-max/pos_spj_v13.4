...
class InventoryEvents:
    ...
    INVENTORY_TEMPERATURE_EXCURSION_RESOLVED = "INVENTORY_TEMPERATURE_EXCURSION_RESOLVED"
    ...
    # labels / printing (INV-26)
    INVENTORY_LABEL_PRINTED = "INVENTORY_LABEL_PRINTED"
    INVENTORY_LABEL_REPRINTED = "INVENTORY_LABEL_REPRINTED"
