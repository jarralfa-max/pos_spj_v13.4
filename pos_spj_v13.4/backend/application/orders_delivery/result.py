...
_ERROR_CODES: tuple[tuple[type[OrdersDeliveryDomainError], str], ...] = (
    ...
    (DeliveryZoneNotFoundError, "DELIVERY_ZONE_NOT_FOUND"),
    (ProductNotAvailableForOrderError, "PRODUCT_NOT_AVAILABLE"),
    (InvalidDeliveryZoneError, "INVALID_DELIVERY_ZONE"),
    (DeliveryZoneOverlapError, "DELIVERY_ZONE_OVERLAP"),
