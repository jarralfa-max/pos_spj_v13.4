"""Structured result returned by Customer Master use cases (mirrors
backend/application/suppliers/result.py, the HR/finance pattern)."""
...
class CustomerResult:
    ...
    def ok(cls, message: str = "", *, entity_id: str | None = None,
           operation_id: str | None = None, **data) -> "CustomerResult":
