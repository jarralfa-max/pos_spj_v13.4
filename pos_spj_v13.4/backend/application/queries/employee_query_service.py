"""Read-only QueryService for the employees UI/API read models."""
...
class EmployeeQueryService(BaseQueryService):
    scope = "employees"

    def search_employees(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
