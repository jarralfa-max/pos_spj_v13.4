"""Read-only QueryService for the cash register UI/API read models."""
...
class CashRegisterQueryService(BaseQueryService):
    scope = "cash_register"

    def search_cash_records(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
