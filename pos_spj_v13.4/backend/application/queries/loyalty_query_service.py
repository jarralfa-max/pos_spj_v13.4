"""Read-only QueryService for the loyalty UI/API read models."""
...
class LoyaltyQueryService(BaseQueryService):
    scope = "loyalty"

    def search_loyalty_accounts(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
