"""Read-only QueryService for the suppliers UI/API read models."""
...
class SupplierQueryService(BaseQueryService):
    scope = "suppliers"

    def search_suppliers(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
