"""Read-only QueryService for the assets UI/API read models."""
...
class AssetQueryService(BaseQueryService):
    scope = "assets"

    def search_assets(self, query: str, filters: QueryFilters | None = None) -> list[SearchResult]:
