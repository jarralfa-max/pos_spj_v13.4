"""Structured result returned by Customer Credit use cases. Mirrors
backend/application/customer_service/result.py."""
...
class CustomerCreditResult:
    ...
    def ok(cls, message: str = "", *, entity_id: str | None = None,
           operation_id: str | None = None, **data) -> "CustomerCreditResult":
