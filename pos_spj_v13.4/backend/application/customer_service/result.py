"""Structured result returned by Customer Service use cases. Mirrors
backend/application/crm/result.py."""
...
class CustomerServiceResult:
    ...
    def ok(cls, message: str = "", *, entity_id: str | None = None,
           operation_id: str | None = None, **data) -> "CustomerServiceResult":
