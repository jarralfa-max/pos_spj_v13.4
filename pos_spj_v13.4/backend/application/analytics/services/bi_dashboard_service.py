...
from backend.application.analytics.dto.bi_dashboard_dto import (
    ...
    def _kpis(self, c: dict, p: dict) -> list[KpiCard]:
        return [
            make_kpi("ventas_netas", "Ventas netas", c["ventas_netas"], p["ventas_netas"],
                     unit="$", icon="💵", variant="success",
                     tooltip="Total vendido (completadas) del periodo.",
            ...
            make_kpi("rotacion", "Rotación inventario", c["rotacion"], p["rotacion"],
                     unit="x", icon="🔄", variant="primary",
                     tooltip="Costo de ventas / inventario valorizado.",
