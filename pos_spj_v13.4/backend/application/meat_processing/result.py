"""Structured result returned by Meat Processing use cases (mirrors
backend/application/inventory/result.py)."""
...
class MeatProcessingResult:
    ...
    def ok(cls, message: str = "", *, entity_id: str | None = None,
           operation_id: str | None = None, **data) -> "MeatProcessingResult":
