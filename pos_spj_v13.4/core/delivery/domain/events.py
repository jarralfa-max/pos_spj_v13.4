...
class DeliveryEvents(StrEnum):
    ...
    TOTAL_FINALIZED = "DELIVERY_TOTAL_FINALIZED"
...
EVENT_PAYLOAD_CONTRACTS: Mapping[DeliveryEvents, EventContract] = {
    ...
    DeliveryEvents.TOTAL_FINALIZED: EventContract(("order_id", "delivery_id", "customer_id", "branch_id", "final_total", "advance_paid", "balance_due", "payment_method"), "Total definitivo del pedido finalizado para Caja/Finanzas.", critical=True),
