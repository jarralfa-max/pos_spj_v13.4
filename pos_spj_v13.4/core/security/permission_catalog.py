...
CANONICAL_MODULE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "CAJA": [
        ...
        "exportar",
        "dispositivo.ver", "dispositivo.gestionar", "dispositivo.activar",
        "dispositivo.bloquear",
        "cajon.gestionar", "cajon.abrir", "cajon.abrir_sin_venta",
        "terminal.gestionar", "terminal.operar",
        ...
        "conteo.iniciar", "conteo.capturar", "conteo.confirmar",
        "conteo.ver_esperado", "conteo.cancelar",
        "corte_x.generar", "corte_x.ver",
        "corte_z.generar", "corte_z.ver", "corte_z.reimprimir",
        "diferencia.ver", "diferencia.explicar", "diferencia.revisar",
        "diferencia.resolver",
        "entrega.preparar", "entrega.entregar", "entrega.recibir",
        "entrega.disputar",
        "reembolso.solicitar", "reembolso.autorizar",
    ...
    "CRM": [
        ...
        "carteras.ver", "carteras.gestionar",
