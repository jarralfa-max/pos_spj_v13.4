...
CANONICAL_MODULE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "PRODUCCION": [
        ...
        "operario.asignar", "operario.liberar",
        "incidencia.reportar", "incidencia.resolver",
        ...
        "calidad.solicitar_inspeccion", "calidad.registrar_decision",
        ...
        "recurso.ver", "recurso.gestionar", "equipo.ver", "equipo.gestionar",
        "equipo.asignar", "equipo.liberar", "equipo.mantenimiento",
        "empaque.ejecutar", "etiqueta.imprimir", "etiqueta.reimprimir",
        "configuracion.ver", "configuracion.editar",
        "notificacion.gestionar", "whatsapp.gestionar", "alerta.enviar",
    ...
    # Bounded context de Activos / EAM (granular; ver
    # backend/application/assets/permissions.py). Reemplaza el stub plano
    # ["ver", "crear", "mantenimiento"] — misma transformación que
    # COMPRAS/INVENTARIO/FINANZAS ya tuvieron (ASSET-2).
    "ACTIVOS": [
        "ver", "ver.dashboard", "ver.busqueda_global", "ver.auditoria",
        "configuracion.ver", "configuracion.editar",
        "ver.propios", "ver.sucursal", "ver.empresa",
        "crear", "editar", "editar.sensible",
        "comisionar", "suspender", "reactivar", "condicion.cambiar",
        "custodia.ver", "custodia.asignar", "custodia.reasignar", "custodia.devolver",
        "prestamo.crear", "prestamo.devolver", "custodia.historial",
        "transferencia.ver", "transferencia.solicitar", "transferencia.aprobar",
        "transferencia.preparar", "transferencia.enviar", "transferencia.recibir",
        "transferencia.rechazar", "transferencia.cancelar",
        "mantenimiento.ver", "mantenimiento.plan.ver", "mantenimiento.plan.crear",
        "mantenimiento.plan.editar", "mantenimiento.orden.ver", "mantenimiento.orden.crear",
        "mantenimiento.orden.aprobar", "mantenimiento.orden.asignar",
        "mantenimiento.orden.iniciar", "mantenimiento.orden.pausar",
        "mantenimiento.orden.completar", "mantenimiento.orden.cerrar",
        "mantenimiento.orden.cancelar", "mantenimiento.costo.ver", "mantenimiento.costo.editar",
        "inspeccion.ver", "inspeccion.crear", "inspeccion.ejecutar",
        "inspeccion.aprobar", "inspeccion.anular",
        "costo.ver", "proyeccion_financiera.ver",
        "capitalizacion.ver", "capitalizacion.proponer", "capitalizacion.enviar",
        "capitalizacion.cancelar",
        "inventario_fisico.ver", "inventario_fisico.crear", "inventario_fisico.contar",
        "inventario_fisico.completar", "diferencia.ver", "diferencia.resolver",
        "documento.ver", "documento.subir", "documento.descargar", "documento.eliminar",
        "garantia.ver", "garantia.gestionar", "seguro.ver", "seguro.gestionar",
        "baja.ver", "baja.solicitar", "baja.revisar", "baja.aprobar",
        "baja.rechazar", "baja.ejecutar", "baja.cancelar",
        "etiqueta.ver", "etiqueta.crear", "etiqueta.imprimir",
        "etiqueta.reimprimir", "etiqueta.reemplazar",
    ],
    ...
    # Bounded context de Business Intelligence / Analytics / Forecasting /
    # Decision Intelligence (BI-2; granular nuevo ver
    # backend/application/analytics/permissions.py). Los primeros 11 códigos
    # planos (ver..configurar) son el catálogo legacy pre-BI-2 — se
    # conservan sin cambios porque security/rbac.py y
    # backend/application/services/bi_dashboard_service.py ya los usan tal
    # cual; el resto es la ampliación granular punteada (mismo estándar que
    # COMPRAS/PRODUCCION) para forecast, decision intelligence, escenarios,
    # alertas y acceso web remoto futuro.
    "INTELIGENCIA_BI": [
        "ver", "ver_ventas", "ver_inventario", "ver_compras", "ver_caja",
        "ver_clientes", "ver_proveedores", "ver_finanzas", "ver_merma",
        "exportar", "configurar",
        "acceso", "dashboard.ver", "busqueda_global", "auditoria.ver",
        "configuracion.ver", "configuracion.editar",
        "ventas.ver", "ventas.detalle.ver", "ventas.margen.ver", "ventas.exportar",
        "inventario.ver", "inventario.valor.ver", "inventario.riesgo.ver",
        "inventario.forecast.ver",
        "compras.ver", "compras.costo.ver", "compras.forecast.ver",
        "compras.recomendacion.ver",
        "produccion.ver", "produccion.rendimiento.ver", "produccion.forecast.ver",
        "produccion.recomendacion.ver",
        "pricing.ver", "pricing.margen.ver", "pricing.elasticidad.ver",
        "pricing.recomendacion.ver", "pricing.escenario.ver",
        "finanzas.ver", "finanzas.rentabilidad.ver", "finanzas.flujo_caja.ver",
        "finanzas.sensible.ver",
        "forecast.ver", "forecast.demanda.ver", "forecast.ventas.ver",
        "forecast.inventario.ver", "forecast.compras.ver", "forecast.produccion.ver",
        "forecast.sucursales.ver", "forecast.modelo.ver", "forecast.modelo.crear",
        "forecast.modelo.probar", "forecast.modelo.aprobar", "forecast.modelo.activar",
        "forecast.modelo.retirar",
        "recomendacion.ver", "recomendacion.reconocer", "recomendacion.aprobar",
        "recomendacion.rechazar", "recomendacion.descartar",
        "escenario.ver", "escenario.crear", "escenario.compartir", "escenario.eliminar",
        "alerta.ver", "alerta.reconocer", "alerta.resolver", "alerta.descartar",
        "alerta_regla.ver", "alerta_regla.crear", "alerta_regla.editar",
        "alerta_regla.activar", "alerta_suscripcion.gestionar",
        "remoto.acceso", "remoto.ejecutivo.ver", "remoto.sucursal.ver",
        "remoto.forecast.ver", "remoto.alertas.ver", "remoto.recomendaciones.ver",
    ],
    "WHATSAPP": ["ver"],
