...
def _wire_finanzas(bus, container) -> None:
    ...
    # Payroll → finance posting is owned by the HR/finance bounded contexts:
    # PayPayrollRunUseCase emits the canonical PAYROLL_PAID event consumed by
    # backend.application.event_handlers.finance.payroll_paid_handler.
