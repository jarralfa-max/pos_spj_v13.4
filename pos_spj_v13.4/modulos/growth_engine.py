...
class GrowthEngine:
    ...
    def get_growth_config(self) -> dict:
        return {
            "growth_expiry_dias": self._cfg("growth_expiry_dias", "90"),
            "growth_otp_umbral": self._cfg("growth_otp_umbral", "200"),
            "growth_costo_estrella": self._cfg("growth_costo_estrella", "0.80"),
            "growth_cap_pct": self._cfg("growth_cap_pct", "0.50"),
        }
