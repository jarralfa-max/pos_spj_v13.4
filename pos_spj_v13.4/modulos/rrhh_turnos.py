...
class ModuloRRHHTurnos(QWidget):
    ...
    def _build_ui(self):
        ...
        btn_notif.setObjectName("primaryBtn")
        ...
        btn_row = QHBoxLayout()
        btn_add_r = QPushButton("➕ Nuevo rol"); btn_add_r.setObjectName("successBtn"); btn_add_r.setStyleSheet("background:#27ae60;color:white;padding:5px 12px;")
        btn_edit_r = QPushButton("✏️ Editar"); btn_edit_r.setObjectName("warningBtn"); btn_edit_r.setStyleSheet("background:#f39c12;color:white;padding:5px 12px;")
        btn_del_r  = QPushButton("🗑️ Eliminar"); btn_del_r.setObjectName("dangerBtn"); btn_del_r.setStyleSheet("background:#e74c3c;color:white;padding:5px 12px;")
        ...
        btn_add_a  = QPushButton("➕ Asignar turno"); btn_add_a.setObjectName("successBtn"); btn_add_a.setStyleSheet("background:#27ae60;color:white;padding:5px 12px;")
        btn_edit_a = QPushButton("✏️ Editar"); btn_edit_a.setObjectName("warningBtn"); btn_edit_a.setStyleSheet("background:#f39c12;color:white;padding:5px 12px;")
        btn_del_a  = QPushButton("🗑️ Quitar"); btn_del_a.setObjectName("dangerBtn"); btn_del_a.setStyleSheet("background:#e74c3c;color:white;padding:5px 12px;")
        ...
        btn_save_n.setObjectName("successBtn")
