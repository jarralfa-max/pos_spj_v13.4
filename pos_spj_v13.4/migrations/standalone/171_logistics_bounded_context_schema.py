...
DDL = (
    ...
    """CREATE TABLE IF NOT EXISTS logistics_container_type_compatibility (
        id TEXT PRIMARY KEY, parent_type_id TEXT NOT NULL REFERENCES logistics_container_types(id),
    ...
    """CREATE TABLE IF NOT EXISTS logistics_physical_containers (
        id TEXT PRIMARY KEY, container_code TEXT NOT NULL UNIQUE,
    ...
    """CREATE TABLE IF NOT EXISTS logistics_shipments (
        id TEXT PRIMARY KEY, shipment_number TEXT NOT NULL UNIQUE, origin_type TEXT NOT NULL,
    ...
    """CREATE TABLE IF NOT EXISTS logistics_shipment_sources (
        id TEXT PRIMARY KEY, shipment_id TEXT NOT NULL REFERENCES logistics_shipments(id),
    ...
    """CREATE TABLE IF NOT EXISTS logistics_shipment_contents (
        id TEXT PRIMARY KEY, shipment_node_id TEXT NOT NULL REFERENCES logistics_shipment_nodes(id),
        source_document_type TEXT NOT NULL, source_document_id TEXT NOT NULL,
    ...
    """CREATE TABLE IF NOT EXISTS logistics_container_seals (
        id TEXT PRIMARY KEY, seal_code TEXT NOT NULL UNIQUE, seal_type TEXT NOT NULL,
    ...
    """CREATE TABLE IF NOT EXISTS logistics_container_labels (
        id TEXT PRIMARY KEY, container_id TEXT NOT NULL REFERENCES logistics_physical_containers(id),
    ...
    """CREATE TABLE IF NOT EXISTS logistics_print_jobs (
        id TEXT PRIMARY KEY, label_id TEXT NOT NULL REFERENCES logistics_container_labels(id),
    ...
    """CREATE TABLE IF NOT EXISTS logistics_audit_log (
        id TEXT PRIMARY KEY, actor_user_id TEXT NOT NULL, branch_id TEXT,
    ...
    """CREATE TABLE IF NOT EXISTS logistics_outbox (
        id TEXT PRIMARY KEY, event_id TEXT NOT NULL UNIQUE, event_name TEXT NOT NULL,
