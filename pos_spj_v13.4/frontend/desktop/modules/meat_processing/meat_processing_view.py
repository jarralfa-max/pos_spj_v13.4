"""Enterprise Meat Processing workspace with persistent permission-aware
sidebar. Mirrors frontend/desktop/modules/losses/losses_view.py.
"""
...
class MeatProcessingView(QWidget):
    def __init__(self, *, has_permission, badges=None, has_feature=None,
                 page_builder=None, parent=None) -> None:
        super().__init__(parent)
        self.setObjectName("meatProcessingModule")
        self.setAccessibleName("Módulo de procesamiento cárnico")
        self.setAccessibleDescription(
            "Espacio de trabajo para planear, ejecutar y conciliar órdenes de "
        ...
        layout.setSpacing(0)
        self.sidebar = MeatProcessingSidebarWidget(
            has_permission=has_permission, badges=badges, has_feature=has_feature,
            parent=self)
