...
from frontend.desktop.modules.finance.finance_view_models import TableViewModel
...
class FinancePage(QWidget):
    ...
    def reload(self) -> None:
        try:
            ...
            QMessageBox.warning(self, "Finanzas", f"No fue posible cargar la vista:\n{exc}")
    ...
    def notify(self, ok: bool, message: str) -> None:
        if ok:
            QMessageBox.information(self, "Finanzas", message)
            self.reload()
        else:
            QMessageBox.warning(self, "Finanzas", message)
