"""Diálogo de aportación de capital."""
...
class CapitalContributionDialog(FinanceFormDialog):
    dialog_title = "Aportación de capital"
    ...
    def _build_form(self) -> None:
        ...
        self.contributor_input = QLineEdit(self)
        self.form.addRow("Importe:", self.amount_input)
        self.form.addRow("Cuenta destino:", self.account_combo)
        self.form.addRow("Aportante:", self.contributor_input)
