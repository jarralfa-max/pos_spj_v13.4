...
GROUP_ICONS: dict[str, str] = {
    ...
    "Prospectos": Icons.SEARCH,
    "Oportunidades": Icons.SCENARIO,
    "Actividades": Icons.CALENDAR,
    "Atención al cliente": Icons.PHONE,
    "Relación comercial": Icons.SALES,
    "Crédito": Icons.FINANCE,
    "Segmentación": Icons.CATEGORY,
    "Comunicaciones": Icons.NOTIFICATIONS,
    "Privacidad": Icons.LOCK,
    "Control": Icons.AUDIT,
}
...
CUSTOMER_CRM_ROUTES: tuple[CustomerCrmRoute, ...] = (
    # -- Resumen -------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.overview", icon=Icons.DASHBOARD, label="Resumen", group="Resumen",
    ...
    # -- Clientes --------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.directory", icon=Icons.CUSTOMERS, label="Directorio", group="Clientes",
    ...
    CustomerCrmRoute(
        route_id="customers.edit", icon=Icons.EDIT, label="Editar cliente", group="Clientes",
        tooltip="Edición de los datos de identidad de un cliente.",
        required_permission=CustomerPermissions.EDIT, capability="clientes"),
    CustomerCrmRoute(
        route_id="customers.accounts", icon=Icons.COMPANY, label="Cuentas comerciales", group="Clientes",
    ...
    # -- Prospectos --------------------------------------------------------------
    CustomerCrmRoute(
        route_id="crm.leads", icon=Icons.LIST, label="Prospectos", group="Prospectos",
        tooltip="Directorio de leads.",
        required_permission=CRMPermissions.LEADS_VIEW, capability="prospectos"),
    CustomerCrmRoute(
        route_id="crm.lead_detail", icon=Icons.USER, label="Detalle de lead", group="Prospectos",
        tooltip="Expediente de un lead.",
        required_permission=CRMPermissions.LEADS_VIEW, capability="prospectos"),
    CustomerCrmRoute(
        route_id="crm.lead_qualification", icon=Icons.GRADE, label="Calificación", group="Prospectos",
        tooltip="Calificación de leads (BANT, score, manual).",
        required_permission=CRMPermissions.LEADS_VIEW, capability="prospectos"),
    CustomerCrmRoute(
        route_id="crm.lead_conversion", icon=Icons.SCENARIO, label="Conversión", group="Prospectos",
        tooltip="Conversión de lead a cliente/oportunidad.",
        required_permission=CRMPermissions.LEADS_VIEW, capability="prospectos"),
    CustomerCrmRoute(
        route_id="crm.leads_discarded", icon=Icons.DISPOSAL, label="Leads descartados", group="Prospectos",
    ...
    CustomerCrmRoute(
        ...
        required_permission=CRMPermissions.OPPORTUNITIES_VIEW, capability="oportunidades"),
    CustomerCrmRoute(
        route_id="crm.opportunity_detail", icon=Icons.DOCUMENT, label="Detalle de oportunidad", group="Oportunidades",
    ...
    # -- Actividades -----------------------------------------------------------
    CustomerCrmRoute(
        route_id="crm.calendar", icon=Icons.CALENDAR, label="Agenda", group="Actividades",
    ...
    CustomerCrmRoute(
        ...
        required_permission=CRMPermissions.ACTIVITIES_VIEW, capability="actividades"),
    CustomerCrmRoute(
        route_id="crm.meetings", icon=Icons.COMPANY, label="Reuniones", group="Actividades",
        tooltip="Registro de reuniones.",
        required_permission=CRMPermissions.ACTIVITIES_VIEW, capability="actividades"),
    CustomerCrmRoute(
        route_id="crm.visits", icon=Icons.LOCATION, label="Visitas", group="Actividades",
    ...
    # -- Atención al cliente -------------------------------------------------
    CustomerCrmRoute(
        route_id="crm.service_cases", icon=Icons.LIST, label="Casos", group="Atención al cliente",
        tooltip="Bandeja de casos de atención.",
        required_permission=CRMPermissions.CASES_VIEW, capability="atencion"),
    CustomerCrmRoute(
        route_id="crm.case_detail", icon=Icons.DOCUMENT, label="Detalle de caso", group="Atención al cliente",
        tooltip="Expediente de un caso.",
        required_permission=CRMPermissions.CASES_VIEW, capability="atencion"),
    CustomerCrmRoute(
        route_id="crm.complaints", icon=Icons.FLAG, label="Quejas", group="Atención al cliente",
        tooltip="Casos tipo queja.",
        required_permission=CRMPermissions.CASES_VIEW, capability="atencion"),
    CustomerCrmRoute(
        route_id="crm.requests", icon=Icons.REQUEST, label="Solicitudes", group="Atención al cliente",
        tooltip="Casos tipo solicitud.",
        required_permission=CRMPermissions.CASES_VIEW, capability="atencion"),
    CustomerCrmRoute(
        route_id="crm.incidents", icon=Icons.INCIDENT, label="Incidencias", group="Atención al cliente",
    ...
    # -- Relación comercial ----------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.purchase_history", icon=Icons.PURCHASES, label="Compras", group="Relación comercial",
        tooltip="Historial de compras del cliente.",
        required_permission=CustomerPermissions.ORDERS_VIEW, capability="comercial"),
    CustomerCrmRoute(
        route_id="customers.order_history", icon=Icons.ORDERS, label="Pedidos", group="Relación comercial",
        tooltip="Historial de pedidos.",
        required_permission=CustomerPermissions.ORDERS_VIEW, capability="comercial"),
    CustomerCrmRoute(
        route_id="customers.quote_history", icon=Icons.PRICE, label="Cotizaciones", group="Relación comercial",
        tooltip="Historial de cotizaciones.",
        required_permission=CustomerPermissions.ORDERS_VIEW, capability="comercial"),
    CustomerCrmRoute(
        route_id="customers.return_history", icon=Icons.RETURN, label="Devoluciones", group="Relación comercial",
        tooltip="Historial de devoluciones.",
        required_permission=CustomerPermissions.ORDERS_VIEW, capability="comercial"),
    CustomerCrmRoute(
        route_id="customers.product_affinity", icon=Icons.PRODUCTS, label="Productos frecuentes", group="Relación comercial",
        tooltip="Productos de mayor afinidad.",
        required_permission=CustomerPermissions.ORDERS_VIEW, capability="comercial"),

    # -- Crédito ---------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.credit_requests", icon=Icons.REQUEST, label="Solicitudes", group="Crédito",
        tooltip="Solicitudes de crédito.",
        required_permission=CustomerPermissions.CREDIT_VIEW, capability="credito"),
    CustomerCrmRoute(
        route_id="customers.credit_profiles", icon=Icons.DOCUMENT, label="Perfiles de crédito", group="Crédito",
        tooltip="Perfiles y límites de crédito.",
        required_permission=CustomerPermissions.CREDIT_VIEW, capability="credito"),
    CustomerCrmRoute(
        route_id="customers.credit_exposure", icon=Icons.CHART, label="Exposición", group="Crédito",
        tooltip="Exposición y crédito disponible.",
        required_permission=CustomerPermissions.CREDIT_VIEW, capability="credito"),
    CustomerCrmRoute(
        route_id="customers.accounts_receivable", icon=Icons.FINANCE, label="Cuentas por cobrar", group="Crédito",
    ...
    # -- Segmentación ------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.segments", icon=Icons.CATEGORY, label="Segmentos", group="Segmentación",
    ...
    # -- Privacidad --------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.privacy_requests", icon=Icons.REQUEST, label="Solicitudes", group="Privacidad",
    ...
    # -- Control -------------------------------------------------------------
    CustomerCrmRoute(
        route_id="customers.data_quality", icon=Icons.QUALITY, label="Calidad de datos", group="Control",
