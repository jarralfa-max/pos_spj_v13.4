"""Safe read-only page shell used until each BI section supplies its real
page. Mirrors
`frontend/desktop/modules/orders_delivery/pages/placeholder_page.py::OrdersDeliveryPlaceholderPage`
exactly."""
...
class BusinessIntelligencePlaceholderPage(QWidget):
    def __init__(self, *, title: str, subtitle: str, parent=None) -> None:
        super().__init__(parent)
        self.setObjectName("businessIntelligencePage")
        ...
        apply_tooltip(
            ...
            help_id=f"business_intelligence.{title.lower().replace(' ', '_')}",
        )
