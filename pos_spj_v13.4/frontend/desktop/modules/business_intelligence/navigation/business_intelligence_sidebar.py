...
BUSINESS_INTELLIGENCE_NAV: tuple[BiNavEntry, ...] = (
    ...
    BiNavEntry("bi_customers", "Clientes", "customers", P.FINANCE_VIEW,
               "Mejores clientes por compra y cuentas por cobrar."),
    BiNavEntry("bi_inventory", "Inventario", "inventory", P.INVENTORY_VIEW,
               "Valor, rotación, cobertura y riesgo de quiebre/sobre-stock."),
    BiNavEntry("bi_waste", "Merma", "waste", P.INVENTORY_VIEW,
               "Valor de merma, porcentaje sobre venta y reparto por categoría."),
    BiNavEntry("bi_purchasing", "Compras", "purchase", P.PURCHASES_VIEW,
               "Gasto, proveedores y recomendaciones de compra."),
    BiNavEntry("bi_suppliers", "Proveedores", "supplier", P.PURCHASES_VIEW,
               "Compra por proveedor y cuentas por pagar."),
    ...
    BiNavEntry("bi_cash", "Caja", "cash", P.FINANCE_CASHFLOW_VIEW,
               "Ingresos, egresos, saldo y comportamiento diario de caja."),
