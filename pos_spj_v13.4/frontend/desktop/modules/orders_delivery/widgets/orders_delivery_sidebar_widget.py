"""Accessible persistent sidebar for the Pedidos y Delivery workspace.
Mirrors
...
class OrdersDeliverySidebarWidget(QListWidget):
    ...
    def __init__(self, *, has_permission, badges=None, parent=None) -> None:
        ...
        self.setAccessibleDescription(
            "Selecciona una sección de Pedidos y Delivery. Usa las flechas para recorrerla."
        )
